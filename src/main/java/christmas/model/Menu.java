...
public class Menu {
    ...
    public List<Food> addAppetizer(List<Food> foods) {
    ...
    public List<Food> addMain(List<Food> foods) {
        Food food = new FoodBuilder().category("메인").name("티본스테이크").price(55000).build();
        foods.add(food);
    ...
    public List<Food> addDessert(List<Food> foods) {
        Food food = new FoodBuilder().category("디저트").name("초코케이크").price(15000).build();
        foods.add(food);
    ...
    public List<Food> addDrink(List<Food> foods) {
        Food food = new FoodBuilder().category("음료").name("제로콜라").price(3000).build();
        foods.add(food);
